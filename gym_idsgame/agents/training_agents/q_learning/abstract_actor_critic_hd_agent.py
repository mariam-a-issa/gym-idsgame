...
class AbstractActorCriticHDAgent(TrainAgent, ABC):
    """
    Abstract QAgent
    """
    def __init__(self, env:IdsGameEnv, config: AbstractActorCriticHDAgentConfig):
        """
    ...
    def log_metrics(self,
                    episode: int, result: ExperimentResult, attacker_episode_rewards: list,
        ...
        if update_stats and self.config.actor_critic_hd_config is not None and self.config.actor_critic_hd_config.tensorboard:
