...
class AbstractQHDAgent(TrainAgent, ABC):
    """
    Abstract QAgent
    """
    def __init__(self, env:IdsGameEnv, config: AbstractQHDAgentConfig):
        """
    ...
    def log_metrics(self,
        ...
        if update_stats and self.config.qhd_config is not None and self.config.qhd_config.tensorboard:
